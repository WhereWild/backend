"""Compatibility helpers for module vs script execution in ML code."""
...
def import_feature_contract() -> ModuleType:
    """Import the shared ML feature contract for package or script execution."""
    return import_local_module("feature_contract")