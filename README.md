...
FOR HEATMAPS: Unzip the heatmap images into a folder called probabilites within the processed/species folder (path should look like: root/processed/species/probabilities). From there everything should work.